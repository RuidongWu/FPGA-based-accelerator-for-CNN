...
(* CORE_GENERATION_INFO="Layer3_ReadBRAM,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xazu3eg-sfvc784-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.339500,HLS_SYN_LAT=294,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=493,HLS_SYN_LUT=1089,HLS_VERSION=2018_3}" *)

module Layer3_ReadBRAM (
        ap_clk,
        ap_rst_n,
        full_flag,
        full_flag_ap_vld,
...
output   f_Data_ce0;
input  [127:0] f_Data_q0;
output  [127:0] a_Data_TDATA;
...
reg f_Data_ce0;
 ...
 reg    ap_rst_n_inv;
reg   [127:0] a_Data_1_data_out;
reg    a_Data_1_vld_in;
wire    a_Data_1_vld_out;
wire    a_Data_1_ack_in;
wire    a_Data_1_ack_out;
reg   [127:0] a_Data_1_payload_A;
reg   [127:0] a_Data_1_payload_B;
reg    a_Data_1_sel_rd;
reg    a_Data_1_sel_wr;
wire    a_Data_1_sel;
...
reg   [5:0] indvar_flatten1_reg_185;
reg   [4:0] indvar_flatten_reg_196;
reg   [1:0] k_reg_207;
reg   [5:0] indvar_flatten2_reg_218;
reg   [4:0] indvar_flatten3_reg_229;
reg   [1:0] k5_reg_240;
...
wire   [5:0] indvar_flatten_next1_fu_301_p2;
reg   [5:0] indvar_flatten_next1_reg_708;
wire   [1:0] k_mid2_fu_391_p3;
reg   [1:0] k_mid2_reg_713;
wire   [15:0] t_addr_fu_399_p5;
reg   [15:0] t_addr_reg_718;
wire   [4:0] indvar_flatten_next_fu_443_p3;
reg   [4:0] indvar_flatten_next_reg_728;
wire   [16:0] tmp_3_cast_fu_451_p1;
reg   [16:0] tmp_3_cast_reg_733;
wire   [1:0] k_1_fu_475_p2;
reg   [1:0] k_1_reg_748;
wire   [0:0] exitcond_flatten3_fu_495_p2;
wire   [5:0] indvar_flatten_next3_fu_501_p2;
reg   [5:0] indvar_flatten_next3_reg_781;
wire   [1:0] k5_mid2_fu_591_p3;
reg   [1:0] k5_mid2_reg_786;
wire   [15:0] t_addr_1_fu_599_p5;
reg   [15:0] t_addr_1_reg_791;
wire   [4:0] indvar_flatten_next2_fu_643_p3;
reg   [4:0] indvar_flatten_next2_reg_801;
wire   [16:0] tmp_16_cast_fu_651_p1;
reg   [16:0] tmp_16_cast_reg_806;
...
reg   [5:0] ap_phi_mux_indvar_flatten1_phi_fu_189_p4;
reg   [4:0] ap_phi_mux_indvar_flatten_phi_fu_200_p4;
reg   [1:0] ap_phi_mux_k_phi_fu_211_p4;
reg   [5:0] ap_phi_mux_indvar_flatten2_phi_fu_222_p4;
reg   [4:0] ap_phi_mux_indvar_flatten3_phi_fu_233_p4;
reg   [1:0] ap_phi_mux_k5_phi_fu_244_p4;
...
wire   [4:0] indvar_flatten_op_fu_437_p2;
...
wire   [4:0] indvar_flatten32_op_fu_637_p2;
...
always @ (posedge ap_clk) begin
    if ((~(k_mid2_fu_391_p3 == 2'd0) & ~(k_mid2_fu_391_p3 == 2'd1) & (exitcond_flatten1_fu_295_p2 == 1'd0) & (1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        ...
        s_addr_2_2_fu_102 <= 16'd12;
    end
end

always @ (posedge ap_clk) begin
    if (((k5_mid2_fu_591_p3 == 2'd0) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        s_addr_2_3_fu_106 <= s_addr_0_4_fu_616_p2;
    end else if (((~(k5_mid2_fu_591_p3 == 2'd0) & ~(k5_mid2_fu_591_p3 == 2'd1) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1)) | ((k5_mid2_fu_591_p3 == 2'd1) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1)))) begin
        s_addr_2_3_fu_106 <= s_addr_0_10_mid_fu_558_p3;
    end else if (((1'b1 == ap_CS_fsm_state7) & (full_flag_ap_vld == 1'b1))) begin
        s_addr_2_3_fu_106 <= 16'd36;
    end
end

always @ (posedge ap_clk) begin
    if (((~(k5_mid2_fu_591_p3 == 2'd0) & ~(k5_mid2_fu_591_p3 == 2'd1) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1)) | ((k5_mid2_fu_591_p3 == 2'd0) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1)))) begin
        s_addr_2_4_fu_110 <= s_addr_1_6_mid_fu_543_p3;
    end else if (((k5_mid2_fu_591_p3 == 2'd1) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        s_addr_2_4_fu_110 <= s_addr_0_4_fu_616_p2;
    end else if (((1'b1 == ap_CS_fsm_state7) & (full_flag_ap_vld == 1'b1))) begin
        s_addr_2_4_fu_110 <= 16'd42;
    end
end

always @ (posedge ap_clk) begin
    if ((~(k5_mid2_fu_591_p3 == 2'd0) & ~(k5_mid2_fu_591_p3 == 2'd1) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
        s_addr_2_5_fu_114 <= s_addr_0_4_fu_616_p2;
    end else if ((((k5_mid2_fu_591_p3 == 2'd0) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1)) | ((k5_mid2_fu_591_p3 == 2'd1) & (exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0) & (ap_enable_reg_pp1_iter0 == 1'b1)))) begin
        s_addr_2_5_fu_114 <= s_addr_2_6_mid_fu_528_p3;
    end else if (((1'b1 == ap_CS_fsm_state7) & (full_flag_ap_vld == 1'b1))) begin
        s_addr_2_5_fu_114 <= 16'd48;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten3_fu_495_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        k5_mid2_reg_786 <= k5_mid2_fu_591_p3;
...
always @ (posedge ap_clk) begin
    if (((exitcond_flatten3_reg_777 == 1'd0) & (1'b0 == ap_block_pp1_stage1_11001) & (1'b1 == ap_CS_fsm_pp1_stage1))) begin
        tmp_16_cast_reg_806[15 : 0] <= tmp_16_cast_fu_651_p1[15 : 0];
    end
end
...
always @ (*) begin
    if (((exitcond_flatten3_reg_777 == 1'd0) & (ap_enable_reg_pp1_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0))) begin
        ap_phi_mux_k5_phi_fu_244_p4 = k_2_reg_821;
    end else begin
        ap_phi_mux_k5_phi_fu_244_p4 = k5_reg_240;
    end
end
...
assign exitcond_flatten1_fu_295_p2 = ((ap_phi_mux_indvar_flatten1_phi_fu_189_p4 == 6'd48) ? 1'b1 : 1'b0);

assign exitcond_flatten2_fu_516_p2 = ((ap_phi_mux_indvar_flatten3_phi_fu_233_p4 == 5'd12) ? 1'b1 : 1'b0);

assign exitcond_flatten3_fu_495_p2 = ((ap_phi_mux_indvar_flatten2_phi_fu_222_p4 == 6'd48) ? 1'b1 : 1'b0);

assign exitcond_flatten_fu_316_p2 = ((ap_phi_mux_indvar_flatten_phi_fu_200_p4 == 5'd12) ? 1'b1 : 1'b0);

assign indvar_flatten32_op_fu_637_p2 = (ap_phi_mux_indvar_flatten3_phi_fu_233_p4 + 5'd1);

assign indvar_flatten_next1_fu_301_p2 = (ap_phi_mux_indvar_flatten1_phi_fu_189_p4 + 6'd1);

assign indvar_flatten_next2_fu_643_p3 = ((exitcond_flatten2_fu_516_p2[0:0] === 1'b1) ? 5'd1 : indvar_flatten32_op_fu_637_p2);

assign indvar_flatten_next3_fu_501_p2 = (ap_phi_mux_indvar_flatten2_phi_fu_222_p4 + 6'd1);

assign indvar_flatten_next_fu_443_p3 = ((exitcond_flatten_fu_316_p2[0:0] === 1'b1) ? 5'd1 : indvar_flatten_op_fu_437_p2);

assign indvar_flatten_op_fu_437_p2 = (ap_phi_mux_indvar_flatten_phi_fu_200_p4 + 5'd1);

assign k5_mid2_fu_591_p3 = ((tmp_8_fu_585_p2[0:0] === 1'b1) ? 2'd0 : ap_phi_mux_k5_phi_fu_244_p4);

assign k_1_fu_475_p2 = (k_mid2_reg_713 + 2'd1);

assign k_2_fu_675_p2 = (k5_mid2_reg_786 + 2'd1);
...
assign t_addr_1_fu_599_p4 = ((tmp_8_fu_585_p2[0:0] === 1'b1) ? 2'd0 : ap_phi_mux_k5_phi_fu_244_p4);
...
assign tmp_3_fu_573_p2 = ((ap_phi_mux_k5_phi_fu_244_p4 == 2'd3) ? 1'b1 : 1'b0);
...
always @ (posedge ap_clk) begin
    ...
    tmp_16_cast_reg_806[16] <= 1'b0;
end

endmodule //Layer3_ReadBRAM
