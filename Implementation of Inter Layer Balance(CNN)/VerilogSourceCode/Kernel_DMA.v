...
(* CORE_GENERATION_INFO="Kernel_DMA,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xazu3eg-sfvc784-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.357000,HLS_SYN_LAT=2166,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=261,HLS_SYN_LUT=827,HLS_VERSION=2018_3}" *)
...
assign exitcond5_fu_206_p2 = ((p_04_rec_reg_151 == 10'd650) ? 1'b1 : 1'b0);
...
assign p_rec_fu_212_p2 = (p_04_rec_reg_151 + 10'd1);
