proc getPresetInfo {} {
  return [dict create name {Edgeboard_Lite_1200M} description {Edgeboard_Lite_1200M}  vlnv xilinx.com:ip:zynq_ultra_ps_e:3.2 display_name {Edgeboard_Lite_1200M} ]
}
...
proc apply_preset {IPINST} {
  return [dict create \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {########################UART 1#UART 1####################SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1##########################}  \
    CONFIG.PSU_MIO_TREE_SIGNALS {########################txd#rxd####################sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out##########################}  \
