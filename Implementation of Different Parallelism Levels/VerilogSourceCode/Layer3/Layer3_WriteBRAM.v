...
(* CORE_GENERATION_INFO="Layer3_WriteBRAM,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xazu3eg-sfvc784-1-i,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.352000,HLS_SYN_LAT=78,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=291,HLS_SYN_LUT=320,HLS_VERSION=2018_3}" *)

module Layer3_WriteBRAM (
        ap_clk,
        ap_rst_n,
        feature_Data_TDATA,
        feature_Data_TVALID,
...
wire   [5:0] p_rec_fu_165_p2;
wire   [6:0] i_2_fu_176_p2;
...
wire   [63:0] p_0_rec_cast_fu_154_p1;
wire   [63:0] tmp_1_fu_171_p1;
reg   [6:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
reg    ap_idle_pp1;
...
always @ (posedge ap_clk) begin
    if (((exitcond3_fu_159_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        i1_reg_115 <= i_2_fu_176_p2;
    end else if (((full_flag_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        i1_reg_115 <= 7'd36;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond5_fu_142_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        i_reg_104 <= i_1_fu_148_p2;
    end else if ((1'b1 == ap_CS_fsm_state1)) begin
        i_reg_104 <= 6'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond3_fu_159_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001))) begin
        p_1_rec_reg_126 <= p_rec_fu_165_p2;
    end else if (((full_flag_1_ack_in == 1'b1) & (1'b1 == ap_CS_fsm_state5))) begin
        p_1_rec_reg_126 <= 6'd0;
    end
end
...
always @ (*) begin
    if ((exitcond5_fu_142_p2 == 1'd1)) begin
...
always @ (*) begin
    if ((exitcond3_fu_159_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0))) begin
        f_Data_address0 = tmp_1_fu_171_p1;
    end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
        f_Data_address0 = p_0_rec_cast_fu_154_p1;
    end else begin
        f_Data_address0 = 'bx;
    end
end
...
always @ (*) begin
    if ((((exitcond3_fu_159_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0_11001)) | ((exitcond5_fu_142_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001)))) begin
        f_Data_we0 = 1'b1;
    end else begin
        f_Data_we0 = 1'b0;
    end
...
always @ (*) begin
    if ((((exitcond3_fu_159_p2 == 1'd0) & (ap_enable_reg_pp1_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp1_stage0) & (1'b0 == ap_block_pp1_stage0)) | ((exitcond5_fu_142_p2 == 1'd0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0)))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((exitcond5_fu_142_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((exitcond5_fu_142_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        ...
        ap_ST_fsm_pp1_stage0 : begin
            if (~((exitcond3_fu_159_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
                ap_NS_fsm = ap_ST_fsm_pp1_stage0;
            end else if (((exitcond3_fu_159_p2 == 1'd1) & (1'b0 == ap_block_pp1_stage0_subdone) & (ap_enable_reg_pp1_iter0 == 1'b1))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond5_fu_142_p2 == 1'd0) & (feature_Data_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond5_fu_142_p2 == 1'd0) & (feature_Data_0_vld_out == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1));
end

assign ap_block_pp1_stage0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_pp1_stage0_11001 = ((exitcond3_fu_159_p2 == 1'd0) & (feature_Data_0_vld_out == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_pp1_stage0_subdone = ((exitcond3_fu_159_p2 == 1'd0) & (feature_Data_0_vld_out == 1'b0) & (ap_enable_reg_pp1_iter0 == 1'b1));
end

always @ (*) begin
    ap_block_state2_pp0_stage0_iter0 = ((exitcond5_fu_142_p2 == 1'd0) & (feature_Data_0_vld_out == 1'b0));
end

assign ap_block_state3_pp0_stage0_iter1 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state6_pp1_stage0_iter0 = ((exitcond3_fu_159_p2 == 1'd0) & (feature_Data_0_vld_out == 1'b0));
end
...
assign exitcond3_fu_159_p2 = ((p_1_rec_reg_126 == 6'd36) ? 1'b1 : 1'b0);

assign exitcond5_fu_142_p2 = ((i_reg_104 == 6'd36) ? 1'b1 : 1'b0);
...
assign i_1_fu_148_p2 = (i_reg_104 + 6'd1);

assign i_2_fu_176_p2 = (i1_reg_115 + 7'd1);

assign p_0_rec_cast_fu_154_p1 = i_reg_104;

assign p_rec_fu_165_p2 = (p_1_rec_reg_126 + 6'd1);

assign tmp_1_fu_171_p1 = i1_reg_115;

always @ (posedge ap_clk) begin
    full_flag_1_data_reg <= 1'b0;
end

endmodule //Layer3_WriteBRAM
